...
DROP FUNCTION IF EXISTS public.calcular_ticket_medio_selfcheckout(integer,date,date);

-- Recriar função com nova lógica para calcular ticket médio baseado em vendas 'geral' por dia
