  ...
  public: {
    Tables: {
      ...
      controles_entregas: {
        ...
        Relationships: [
          {
            foreignKeyName: "controles_entregas_criado_por_usuario_id_fkey"
          ...
          {
            foreignKeyName: "controles_entregas_entregue_por_usuario_id_fkey"
            columns: ["entregue_por_usuario_id"]
            isOneToOne: false
            referencedRelation: "usuarios"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "controles_entregas_loja_destino_id_fkey"
          ...
          {
            foreignKeyName: "controles_entregas_loja_origem_id_fkey"
